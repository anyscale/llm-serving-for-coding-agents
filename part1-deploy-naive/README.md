...
**What "naive" means here:** 4× L4 (`g6.12xlarge`, TP=4), single replica, weights downloaded from
Hugging Face on every cold start, no compile cache, no autoscaling, no speculative/routing tricks.
