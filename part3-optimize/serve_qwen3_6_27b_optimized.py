...
NVFP4_SOURCE = "nvidia/Qwen3.6-27B-NVFP4"                                    # 4-bit NVFP4 weights (ENABLE_NVFP4_WEIGHT)
...
# NVFP4 weights + fp8 KV / TP=1 / 256K). Used when ENABLE_NVFP4_WEIGHT. Rebuild + new prefix if the image/GPU/flags change.
