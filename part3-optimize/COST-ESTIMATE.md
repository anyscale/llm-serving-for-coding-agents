# Cost Estimate: Self-Hosting vs API Tokens
...
Self-hosting is usually cheaper once a team has more than a few active users. The main risk is model
quality: a cheaper 27B model only saves money if it can finish the same work with an acceptable
...
| Mode | GPU cost | Break-even vs $200 seat | Break-even vs $800 token bill |
|---|---:|---:|---:|
| Always-on, on-demand | ~$2,900/mo | ~15 devs | ~4 devs |
| Always-on, spot | ~$1,700/mo | ~9 devs | ~2 devs |
| Work-hours, on-demand | ~$840/mo | ~4 devs | ~1 dev |
| Work-hours, spot | ~$480/mo | ~3 devs |  ~0.5 dev |
...
on-demand; spot lowers them by about 43%.

| Team size | GPUs | Always-on self-hosted | Work-hours self-hosted | $200 seat | $800 token billing |
|---|---:|---:|---:|---:|---:|
...
- **Model quality:** this compares a 27B self-hosted model with frontier APIs.
